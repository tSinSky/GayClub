        ...
        <div className="mt-10">
          ...
          <div className="flex flex-col md:flex-row gap-8 mb-10">
            ...
            <div className="flex-1">
              <h3 className="text-2xl mb-3 font-medium">{director.name}</h3>
              <MarkdownContent className="prose-sm prose-p:text-zinc-400">{director.bio}</MarkdownContent>
            </div>
          </div>
          ...
          {director.filmography && director.filmography.length > 0 && (
            <div>
              <h4 className="text-xl mb-4 text-zinc-300 font-medium">Избранная фильмография</h4>
